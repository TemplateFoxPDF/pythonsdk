...
class TemplatesApi:
    ...
    def get_template_layers(
        ...
        _param = self._get_template_layers_serialize(
            template_id=template_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_template_layers_with_http_info(
        self,
        template_id: Annotated[StrictStr, Field(description="Template short ID (12 characters)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplateLayersResponse]:
        """Get template layers
    ...
    @validate_call
    def get_template_layers_without_preload_content(
        self,
        template_id: Annotated[StrictStr, Field(description="Template short ID (12 characters)")],
        _request_timeout: Union[
            None,
    ...
    def _get_template_layers_serialize(
        self,
        template_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/templates/{template_id}/layers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_templates(
        self,
        kind: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by product kind: `pdf` or `image`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param kind: Filter by product kind: `pdf` or `image`
        :type kind: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
