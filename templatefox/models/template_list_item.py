...
class TemplateListItem(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default='pdf', description="Template product kind: `pdf` or `image`")
    created_at: StrictStr = Field(description="ISO 8601 timestamp")
    updated_at: StrictStr = Field(description="ISO 8601 timestamp")
    __properties: ClassVar[List[str]] = ["id", "name", "kind", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "kind": obj.get("kind") if obj.get("kind") is not None else 'pdf',
