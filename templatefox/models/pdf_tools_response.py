...
class PdfToolsResponse(BaseModel):
    """
    PdfToolsResponse
    """ # noqa: E501
    url: StrictStr = Field(description="Signed URL to download the PDF")
    filename: StrictStr = Field(description="Filename of the resulting PDF")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PdfToolsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PdfToolsResponse from a dict"""
        if obj is None:
            return None
