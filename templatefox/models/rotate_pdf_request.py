...
class RotatePdfRequest(BaseModel):
    ...
    page_rotations: Optional[Dict[str, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["export_type", "expiration", "filename", "pdf_url", "pdf_base64", "rotation", "page_rotations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RotatePdfRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if page_rotations (nullable) is None
        # and model_fields_set contains the field
        if self.page_rotations is None and "page_rotations" in self.model_fields_set:
            _dict['page_rotations'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RotatePdfRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page_rotations": obj.get("page_rotations")
        })
        return _obj
